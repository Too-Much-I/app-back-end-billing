...
import web.tosunsaeng.billing.trialeligibility.domain.InboundEventDisposition;
...
import web.tosunsaeng.billing.trialeligibility.infrastructure.InboundEventInboxRepository;
...
public class TrialEligibilityEventService {
    ...
    private static TrialEligibilityEventOutcome conflict() {
        throw InternalApiException.eventConflict();
    }
